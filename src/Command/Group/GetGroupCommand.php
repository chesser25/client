...
class GetGroupCommand extends AbstractBaseCommand
{
    /**
     ...
     * @var string
     */
    protected static $defaultName = Constant::GET_GROUP_COMMAND_NAME;

    protected function configure(): void
    {
        $this
            ->setDescription(Constant::GET_GROUP_COMMAND_DESCRIPTION)
